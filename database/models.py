...
blast_block_status_enum = ENUM("planned", "blasted", "assessed", name="blast_block_status", create_type=False)
structure_type_enum = ENUM("joint_set", "tectonic_structure", name="structure_type", create_type=False)
drilling_role_enum = ENUM("production", "buffer", "contour", name="drilling_role", create_type=False)
charge_segment_type_enum = ENUM("explosive", "stemming", "air_deck", name="charge_segment_type", create_type=False)
wall_rating_enum = ENUM("good", "satisfactory", "poor", name="wall_rating", create_type=False)
attachment_kind_enum = ENUM("photo", "document", name="attachment_kind", create_type=False)
