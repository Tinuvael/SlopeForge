...
blast_block_status = postgresql.ENUM("planned", "blasted", "assessed", name="blast_block_status")
structure_type = postgresql.ENUM("joint_set", "tectonic_structure", name="structure_type")
drilling_role = postgresql.ENUM("production", "buffer", "contour", name="drilling_role")
charge_segment_type = postgresql.ENUM("explosive", "stemming", "air_deck", name="charge_segment_type")
wall_rating = postgresql.ENUM("good", "satisfactory", "poor", name="wall_rating")
attachment_kind = postgresql.ENUM("photo", "document", name="attachment_kind")
