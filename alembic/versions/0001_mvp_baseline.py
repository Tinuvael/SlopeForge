...
def upgrade() -> None:
    ...
    sa.Column('boundary_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('final_geometry_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    ...
    sa.Column('imported_at', sa.DateTime(timezone=True), nullable=False),
    sa.Column('source_file_name', sa.String(length=255), nullable=False),
    sa.Column('source_geometry_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('plan_geometry_json', postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column('elevation_m', sa.Numeric(precision=12, scale=3), nullable=False),
    sa.Column('is_active', sa.Boolean(), nullable=False),
    ...
    sa.Column('frozen_intersection_geometry_json', postgresql.JSONB(none_as_null=True, astext_type=sa.Text()), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
