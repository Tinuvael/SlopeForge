...
def occupied_intervals(state: PrototypeState, dataset_id: str | None, source_line_id: str, exclude_segment_id: str | None = None) -> list[OccupiedInterval]:
    ...
    for bench in state.drafts:
        for segment_id in [bench.upper_segment_id, bench.lower_segment_id, *bench.intermediate_segment_ids]:
            ...
            if segment and segment.id != exclude_segment_id and segment.dataset_id == dataset_id and segment.source_line_id == source_line_id:
