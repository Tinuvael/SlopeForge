...
class Header(QWidget):
    add_mine_requested=Signal(); add_domain_requested=Signal(); add_block_requested=Signal(); add_contour_requested=Signal(); add_assessment_area_requested=Signal(); archive_requested=Signal()
    def __init__(self, context):
        ...
        self.add_mine_action=self.add_menu.addAction("Add mine"); self.add_domain_action=self.add_menu.addAction("Add domain"); self.add_block_action=self.add_menu.addAction("Add production block"); self.add_contour_action=self.add_menu.addAction("Add contour blast"); self.add_assessment_area_action=self.add_menu.addAction("Add assessment area")
        self.add_mine_action.triggered.connect(self.add_mine_requested); self.add_domain_action.triggered.connect(self.add_domain_requested); self.add_block_action.triggered.connect(self.add_block_requested); self.add_contour_action.triggered.connect(self.add_contour_requested); self.add_assessment_area_action.triggered.connect(self.add_assessment_area_requested)
