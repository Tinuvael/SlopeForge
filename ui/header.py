...
class Header(QWidget):
    ...
    def __init__(self, context):
        ...
        self.add_project_action=self.add_menu.addAction("Add project"); self.add_domain_action=self.add_menu.addAction("Add domain"); self.add_blast_event_action=self.add_menu.addAction("Add blast event"); self.add_assessment_area_action=self.add_menu.addAction("Add assessment area")
        ...
        self.add_button.setToolTip("Create a project, domain, blast event, or assessment area")
        ...
        self.archive_button.setIcon(ui_icon("archive")); self.search=QLineEdit(); self.search.setPlaceholderText("Search blast events..."); self.search.setMaximumWidth(350); self.settings=QPushButton("Settings"); self.settings.setIcon(ui_icon("settings")); self.settings.clicked.connect(self.open_settings)
