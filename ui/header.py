...
class Header(QWidget):
    ...
    def set_archive_context(self, enabled, archived=False):
        self.archive_button.setEnabled(self.context.current_user.can_edit and enabled); self.archive_button.setText(tr("Restore") if archived else "Archive"); self.archive_button.setIcon(ui_icon("restore" if archived else "archive"))
