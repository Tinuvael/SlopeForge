...
QDialog#StandardEntityDialog QDoubleSpinBox[standardChevronSpinBox="true"]:disabled {
    background: #f1f3f5; color: #9ca3af;
}
QDialog#StandardEntityDialog QDoubleSpinBox[standardChevronSpinBox="true"] QToolButton {
    background: #f8fafc; border: 0; border-left: 1px solid #e1e6ed;
    border-radius: 0; padding: 0; margin: 0;
}
QDialog#StandardEntityDialog QDoubleSpinBox[standardChevronSpinBox="true"] QToolButton#ChevronSpinUpButton {
    border-top-right-radius: 5px; border-bottom: 1px solid #e1e6ed;
}
QDialog#StandardEntityDialog QDoubleSpinBox[standardChevronSpinBox="true"] QToolButton#ChevronSpinDownButton {
    border-bottom-right-radius: 5px;
}
QDialog#StandardEntityDialog QDoubleSpinBox[standardChevronSpinBox="true"] QToolButton:hover {
    background: #eef3f8;
}
QDialog#StandardEntityDialog QDoubleSpinBox[standardChevronSpinBox="true"] QToolButton:pressed {
    background: #dfe8f2;
}
QDialog#StandardEntityDialog QDoubleSpinBox[standardChevronSpinBox="true"] QToolButton:disabled {
