...
class AssessmentAreaPage(QWidget):
    ...
    def _build_editor(self):
        ...
        geometry_line=QFrame(); geometry_line.setFrameShape(QFrame.Shape.HLine); geometry_line.setObjectName("SectionDivider"); inputs.addWidget(geometry_line)
        ...
        self.face_condition_divider=QFrame(); self.face_condition_divider.setFrameShape(QFrame.Shape.HLine); self.face_condition_divider.setObjectName("SectionDivider"); inputs.addWidget(self.face_condition_divider)
