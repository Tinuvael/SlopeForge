...
class AssessmentAreaPage(QWidget):
    ...
    def _build_editor(self):
        ...
        self.override_reason_label=QLabel(tr("Manual matrix selection reason")); context_form.addRow(self.override_reason_label,self.evaluation_editor.override_reason); manual_matrix=draft.matrix_selection_source=="manual_override"; self.override_reason_label.setVisible(manual_matrix); self.evaluation_editor.override_reason.setVisible(manual_matrix)
