...
class BlockListPage(QWidget):
    ...
    def _load_filters(self) -> None:
        self.mine_filter.blockSignals(True); self.mine_filter.clear(); self.mine_filter.addItem("All mines", None)
    ...
    def _reload_site_filter(self) -> None:
        self.site_filter.blockSignals(True); self.site_filter.clear(); self.site_filter.addItem("All sites", None)
