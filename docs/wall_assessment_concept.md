...
> Project Lines Dataset задаёт версионную проектную основу. Blast Event хранит параметры, промежуточную оценку и ревизии фактической геометрии. Assessment Area имеет стабильную идентичность и хранит историю неизменяемых ревизий границ; связывание с событиями остаётся следующим этапом разработки.
